	...
	<body>
		...
		<div class="container" id="main">
			...
			<div class="row" id="info">
				<div class="col-sm-12">
					<h2><center><b>Registration</b></center></h2>
					<p><center></center></p>
					<hr>
					...
					<script>
						var rootRef = new Firebase('https://elite300-com.firebaseio.com/'),
								inquiryRef = rootRef.child("registrants"),
